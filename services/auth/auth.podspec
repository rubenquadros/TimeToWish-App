Pod::Spec.new do |spec|
    spec.name                     = 'auth'
    spec.version                  = '1.0'
    spec.homepage                 = 'Link to the Auth Module homepage'
    spec.source                   = { :http=> ''}
    spec.authors                  = ''
    spec.license                  = ''
    spec.summary                  = 'This is the auth module'
    ...
    if !Dir.exist?('build/cocoapods/framework/auth.framework') || Dir.empty?('build/cocoapods/framework/auth.framework')
        ...
        'pod install' should be executed after running ':generateDummyFramework' Gradle task:
            ...
            ./gradlew :services:auth:generateDummyFramework
    ...
    spec.pod_target_xcconfig = {
        'KOTLIN_PROJECT_PATH' => ':services:auth',
